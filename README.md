### TagEditor(v1.5) annotation tool
...
You can load data from PreCo dataset to TagEditor directly. Unzip  PreCo dataset , run tagEditor and select File->Load PreCO/Coref->(select file) <br/>
